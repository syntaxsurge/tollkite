...
export function GET() {
  return NextResponse.json({
    ...
    info: {
      ...
      version: '1.0.0',
      description:
        'USDT-native paid API marketplace and x402 gateway for the configured EVM network.'
    },
    servers: [
      {
    ...
    paths: {
      ...
      '/api/x402/orders/{orderId}/claim': {
        post: {
          ...
          responses: {
            ...
            '402': { description: 'x402 USDT delta payment required' }
          }
        }
      },
      ...
      '/api/credits/top-ups': {
        post: {
          tags: ['Credits'],
          summary: 'Record a USDT top-up for managed API-key usage',
          requestBody: {
            required: true,
            content: {
              'application/json': {
      ...
      '/api/receipts/{receiptId}': {
        get: {
          tags: ['Receipts'],
          summary: 'Get a USDT settlement receipt',
          parameters: [
            {
              name: 'receiptId',
              in: 'path',
    ...
    components: {
      securitySchemes: {
        x402Payment: {
          ...
          name: 'X-PAYMENT',
          description:
            'Signed x402 payment payload generated by an x402 buyer client for USDT settlement on the configured EVM network.'
        },
        managedCreditApiKey: {
          type: 'http',
          scheme: 'bearer',
...
function paidCallOperation(method: 'GET' | 'POST') {
  return {
    ...
    responses: {
      ...
      '402': {
        description: 'x402 USDT payment required'
      },
      '502': {
